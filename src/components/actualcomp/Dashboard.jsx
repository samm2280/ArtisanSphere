...
import image1 from "../images/back7.jpg";
import image2 from "../images/back6.jpg";
import image3 from "../images/back2.jpg";
import image4 from "../images/back4.jpg";
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 lg:px-12">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            >
              Need a service <br /> or have a problem?
            </h1>
            <p 
              ref={textReff}
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-end py-8 lg:py-0">
