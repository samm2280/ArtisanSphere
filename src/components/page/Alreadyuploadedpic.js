...
const Alreadyuploadedpic = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-4 pr-6 pb-8 pl-10">
      {/* Adjusted padding-top to reduce the space below the navbar */}
      <h2 className="text-center pt-14 text-4xl">Images Uploaded by User</h2>
      <div className="flex flex-wrap justify-center">
        {userImages.length > 0 ? ( // Render user's images if available
          userImages.map((imageUrl, index) => (
            <div key={index} className="max-w-sm m-4 pt-8">
